...
class Roundtrip_Path_Planner:
    def __init__(self, startpos, targetlist, environment, plannerName, sortTargetlist=True):
        ...
        supportedPlanners["visibilityPRM_custom_2"] = [IPVisibilityPRM_Customized_connect_all_nodes.VisPRM_Custom_2, visbility_custom_2_Config, IPVISVisibilityPRM_Customized.visibilityPRM_custom_Visualize, False] # True: Multi Query

        visbility_custom_3_Config = dict()
        visbility_custom_3_Config["ntry"] = 300
        supportedPlanners["visibilityPRM_custom_3"] = [IPVisibilityPRM_Customized.VisPRM_Custom_3, visbility_custom_3_Config, IPVISVisibilityPRM_Customized.visibilityPRM_custom_Visualize, False] # True: Multi Query
