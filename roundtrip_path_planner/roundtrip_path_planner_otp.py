...
class Roundtrip_Path_Planner:
    def __init__(self, startpos, targetlist, environment, plannerName):
        ...
        supportedPlanners["basePRM"] = [IPBasicPRM.BasicPRM, basicConfig, IPVISBasicPRM.basicPRMVisualize, True] # True: Multi Query

        basicConfig2 = dict()
        basicConfig2["radius"] = 6
        basicConfig2["numNodes"] = 600
        supportedPlanners["basePRM2"] = [IPBasicPRM.BasicPRM, basicConfig2, IPVISBasicPRM.basicPRMVisualize, True] # True: Multi Query

        visbilityConfig = dict()
        visbilityConfig["ntry"] = 300
        supportedPlanners["visibilityPRM"] = [IPVisibilityPRM.VisPRM, visbilityConfig, IPVISVisibilityPRM.visibilityPRMVisualize, True] # True: Multi Query

        visbility_custom_Config = dict()
        visbility_custom_Config["ntry"] = 300
        supportedPlanners["visibilityPRM_custom"] = [IPVisibilityPRM_Customized.VisPRM_Custom, visbility_custom_Config, IPVISVisibilityPRM_Customized.visibilityPRM_custom_Visualize, True] # True: Multi Query

        visbility_custom_2_Config = dict()
        visbility_custom_2_Config["ntry"] = 300
        supportedPlanners["visibilityPRM_custom_2"] = [IPVisibilityPRM_Customized_2.VisPRM_Custom_2, visbility_custom_2_Config, IPVISVisibilityPRM_Customized.visibilityPRM_custom_Visualize, True] # True: Multi Query

        visbility_custom_3_Config = dict()
        visbility_custom_3_Config["ntry"] = 300
        supportedPlanners["visibilityPRM_custom_3"] = [IPVisibilityPRM_Customized_3.VisPRM_Custom_3, visbility_custom_3_Config, IPVISVisibilityPRM_Customized.visibilityPRM_custom_Visualize, True] # True: Multi Query

        # kClosestConfig = dict()
        # kClosestConfig["k"] = 7
        # kClosestConfig["numNodes"] = 300
        # supportedPlanners["kClosestPRM"] = [IPKClosestPRM.KClosestPRM, kClosestConfig, IPVISBasicPRM.basicPRMVisualize, True] # True: Multi Query

        lazyConfig = dict()
        lazyConfig["initialRoadmapSize"] = 10
        lazyConfig["updateRoadmapSize"]  = 5 
        lazyConfig["kNearest"] = 8
        supportedPlanners["lazyPRM"] = [IPLazyPRM.LazyPRM, lazyConfig, IPVISLazyPRM.lazyPRMVisualize, True] # True: Multi Query
    ...
    def plan(self):
        ...
        # Auswahlverfahren für das nächste Ziel
